...
func TestFindAllPosts(t *testing.T) {
	...
	posts, err := postInstance.FindAll(server.DB)
	if err != nil {
...
func TestSavePost(t *testing.T) {
	...
	savedPost, err := newPost.Save(server.DB)
	if err != nil {
...
func TestGetPostByID(t *testing.T) {
	...
	foundPost, err := postInstance.FindByID(server.DB, post.ID)
	if err != nil {
...
func TestDeleteAPost(t *testing.T) {
	...
	isDeleted, err := postInstance.DeleteByID(server.DB, post.ID, post.AuthorID)
	if err != nil {
		t.Errorf("this is the error updating the user: %v\n", err)
		return
	}
